...
if(isset($_POST['imgupload'])){
 ...
 $sql = "insert into nssimg(image) values ('$file')";
...
if(isset($_POST['deleteimg'])){
	 ...
	 if(mysqli_connect_error()){
		...
		$sql="delete from nssimg where id in (select min(id) from nssimg)";
...
$sql="select fullname,email,phone from nss";
...
if(isset($_POST['uploadach'])){
 ...
 $file=$_FILES['image']['name'];
 $sql = "insert into nss(description,image) values ('$desc','$file')";
 $res=mysqli_query($con,$sql);
if($res){
move_uploaded_file($_FILES['image']['tmp_name'],"$file");
echo "<script language='javascript'>";
...
if(isset($_POST['uploadbox'])&&($_POST['desc']!=NULL)){
	 ...
	 $sql="insert into nss(description,links) values('$desc','$links')";
	 $stmt=$con->prepare($sql);
	 $stmt->execute();
	 	 echo "<script language='javascript'>";
...
if(isset($_POST['deleteupdate'])){
	 ...
	 $sql="delete from nss where id in (select min(id) from nss)";
	 $stmt=$con->prepare($sql);
	 $stmt->execute();
	 	 echo "<script language='javascript'>";
            echo "alert('DELETED')";
