...
$que="select image from chaayaimg";
...
<input id="achbtn" name="chaaya" type="submit" value="Achievements"/> 
</form>
<a href="index.php">
...
<div class=register>
<a href="registrationchaaya.php">Register</a>
</div>
