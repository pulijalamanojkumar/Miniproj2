...
error_reporting(0);
	 ...
	 $sql="select * from mun order by id desc";
...
<input id="achbtn" name="mun" type="submit" value="Achievements"/> 
</form>
<a href="index.php">
...
<input id="regbtn" name="mun" type="submit" value="Register"/> 
</form>
</div>
