...
$que="select image from srujanaimg";
...
<input id="achbtn" name="srujana" type="submit" value="Achievements"/> 
</form>
<a href="index.php">
...
<div class=register>
<a href="registrationsrujana.php">Register</a>
</div>
