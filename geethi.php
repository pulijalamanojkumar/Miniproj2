...
$que="select image from geethiimg";
...
<input id="achbtn" name="geethi" type="submit" value="Achievements"/> 
</form>
<a href="index.php">
...
<div class=register>
<a href="registrationgeethi.php">Register</a>
</div>
