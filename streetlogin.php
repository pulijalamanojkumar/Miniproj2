	   ...
	   <div class="col-sm-12 col-md-6">
        ...
        <div class="btn-icon">
          <i class="far fa-lightbulb"></i>              </div>
	  	  	   ...
	  	  	   <div class="col-sm-12 col-md-6">
        <a class="dedcription-btn" href="nsslogin.php">
          <span class="name-descripeion">Nss Login</span>
        <div class="btn-icon">
          <i class="far fa-lightbulb"></i>              </div>
        </a>
      </div>
	  	   <div class="col-sm-12 col-md-6">
        <a class="dedcription-btn" href="munlogin.php">
          <span class="name-descripeion">MUN Login</span>
        <div class="btn-icon">
          <i class="far fa-lightbulb"></i>              </div>
        </a>
      </div>
	  	   <div class="col-sm-12 col-md-6">
        <a class="dedcription-btn" href="streetlogin.php">
          <span class="name-descripeion">Street Cause Login</span>
        <div class="btn-icon">
          <i class="far fa-lightbulb"></i>              </div>
        </a>
      </div>
	  	   <div class="col-sm-12 col-md-6">
        <a class="dedcription-btn" href="edclogin.php">
          <span class="name-descripeion">EDC Login</span>
        <div class="btn-icon">
          <i class="far fa-lightbulb"></i>              </div>
        </a>
      </div>
...
<div class="formDiv">
        <h1 class="title">StreetCause Login</h1>
        <form action="streetlogin.php" method="POST">
