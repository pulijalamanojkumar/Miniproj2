...
$que="select image from commuimg";
...
<input id="achbtn" name="commu" type="submit" value="Achievements"/> 
</form>
<a href="index.php">
...
<div class=register>
<a href="registrationcommu.php">Register</a>
</div>
