...
error_reporting(0);
	 ...
	 $sql="select * from street order by id desc";
...
<input id="achbtn" name="street" type="submit" value="Achievements"/> 
</form>
<a href="index.php">
...
<input id="regbtn" name="street" type="submit" value="Register"/> 
</form>
</div>
