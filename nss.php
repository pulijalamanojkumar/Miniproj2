...
$que="select image from kreedaimg";
...
error_reporting(0);
	 ...
	 $sql="select * from nss order by id desc";
...
<input id="achbtn" name="nss" type="submit" value="Achievements"/> 
</form>
<a href="index.php">
...
<input id="regbtn" name="nss" type="submit" value="Register"/> 
</form>
</div>
